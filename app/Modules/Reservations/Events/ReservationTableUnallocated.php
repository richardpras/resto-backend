...
class ReservationTableUnallocated extends OutletRealtimeEvent
{
    ...
    {
        return 'reservation.table.unallocated';
    }
    ...
    protected function data(): array
    {
        return [
            ...
            'meta' => $this->meta(
                ...
                'reservation:'.$this->snapshot->id.':unallocated:'.$this->tableId,
            ),
        ];
    }
}
