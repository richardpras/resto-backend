...
class PayrollRunItemV2Resource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'annualTaxableIncome' => (float) $this->annual_taxable_income,
            'pph21Amount' => (float) $this->pph21_amount,
            'reimbursementEarning' => (float) $this->reimbursement_earning,
            'remainingReimbursement' => (float) $this->remaining_reimbursement,
            'annualPkp' => (float) (($this->calculation_json['pph21']['annual_pkp'] ?? 0)),
