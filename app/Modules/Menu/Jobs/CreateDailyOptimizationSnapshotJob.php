...
class CreateDailyOptimizationSnapshotJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(
        MenuOptimizationSnapshotService $snapshotService,
        ...
        $snapshotService->createSnapshot($this->outletId, $this->snapshotDate);
    }
}
